...
import ch.erebetez.activititestapp4.bpmn.forms.InputCalculationValues;
	...
	private UserTaskFormContainer getUserTaskFormContainer() {
		if (userTaskFormContainer == null) {			
			...
			userTaskFormContainer.registerForm(CreateOosForm.FORM_KEY,
					CreateOosForm.class);
			userTaskFormContainer.registerForm(InputCalculationValues.FORM_KEY,
					InputCalculationValues.class);			
		}
