...
A modification of the current Excel plug-in has to be made.
...
This is a rahter exotic configuration. This server should be able to run excel. Therefore windows is the only option al the operating system. On this server there will also run the calculation server (java) which listens to the query of an activiti task.
